const api = {
    key: "2ef2dc3f5b58222b2ee72a3a89b613dc",
...
function displayResults(weather) {
    ...
    // let flags = document.querySelector('.location .city li');
    // flags.innerHTML = `<img src="<img src="https://www.countryflags.io/be/shiny/64.png">`;
    ...
    let icon = document.querySelector('.current .icon li');
